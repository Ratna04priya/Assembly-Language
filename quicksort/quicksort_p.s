...
main: 
       ...
       syscall
             ...
             # store the number of inputs in $s0
       add   $s0, $v0, 0     

             # create memory for input of array - sbrk(allocating heap memory)
       mul   $t0, $s0, 4     
       addi  $a0, $t0, 0     
       li    $v0, 9          
       syscall
...
input: 
       ...
       bne   $s3, $s0, input        #branch on not equal
