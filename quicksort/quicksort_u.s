...
.data
Array:		.word	186, 177, 40, -77, 60, 45, 136, 73, -57, 95, 8, 170, 98, 1, 158, 95, 150, 55, -68, 138, 85, 172, 61, 198, 13
Array_size:	.space	4
msg_before:	.asciiz	"The user defined numbers given in program :\n \n "
msg_after:	.asciiz "\n \n After the quick sort of the given numbers : \n \n"
msg_space:	.asciiz " "
msg_newL:	.asciiz "\n"
...
Loop_main1:
	...
	addi	$t0, $t0, -1                        #arraysize-1
	addi	$s0, $s0, 4                         #memory -4 bits
...
QUICK:
	...
	sw		$ra, 20($sp)	           # store ra
                                                    ...
                                                    # set $s
	move	$s0, $a1		                           # l = left   i.e., storing l=left
	move	$s1, $a2		                           # r = right   i.e., storing r=right
	move	$s2, $a1		                           # p = left    i.e., storing p=pivot
